...
async function counts() { try { return await Promise.all([prisma.organizationPerson.count(), prisma.facultyMember.count(), prisma.event.count()]); } catch { return [null, null, null] as const; } }

export default async function Dashboard() {
  const [people, faculty, events] = await counts();
